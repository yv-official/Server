...
api.add_url_rule('/logout/access', methods=['GET'], view_func=logoutAccess)
api.add_url_rule('/logout/refresh', methods=['GET'], view_func=logoutRefresh)
api.add_url_rule('/token/refresh', methods=['GET'], view_func=tokenRefresh )


#user action routes
# api.add_url_rule('user/edit', methods=['POST'], view_func=editUserProfileDetails)
